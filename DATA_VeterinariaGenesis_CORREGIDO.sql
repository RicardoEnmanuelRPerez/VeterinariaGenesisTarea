/*
==================================================================================
SCRIPT DE DATOS CORREGIDO PARA VeterinariaGenesisDB
==================================================================================
Este script corrige todos los problemas del archivo original DATA_VeterinariaGenesis.sql:
1. Medicamento: Eliminada columna Dosis (la tabla solo tiene Nombre)
2. Servicio: Corregido valor de Eutanasia (de string a decimal)
3. HistoriaClinica: Eliminada completamente (la tabla no existe en el esquema)
4. Factura: Todas las facturas tienen EstadoPago = 'Pagada' (en lugar de valores numéricos)
5. FacturaDetalle: Creado correctamente basado en las citas
6. DetalleHistoria: Eliminada completamente (la tabla no existe en el esquema)

INSTRUCCIONES:
1. Ejecuta primero VeterinariaNGenesisDB.sql para crear el esquema
2. Ejecuta SP,Trigger,users-Veterinaria.sql para crear los SPs
3. Ejecuta este script para poblar los datos
==================================================================================
*/
